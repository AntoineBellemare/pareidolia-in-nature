...
carries of its biome is thus not a catalogue of names but the schemas
of attention, activity, and form a place made available to
imagination. We read mythology as a cultural recording layer of an
ongoing perceptual coupling between cognition and environment, an
interpretation the cross-sectional alignment most naturally
motivates, not a diachronic process these correlational data
