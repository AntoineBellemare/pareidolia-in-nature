...
myth-image geometry without biome labels at all, three independent
controls converging on the same biomes. The alignment decays
...
model can exploit (Supplementary Section~\ref{sec:biome-tell},
...
channel (Supplementary Section~\ref{sec:convergence}), so we read
...
Results and in Supplementary Section~\ref{sec:biome-tell}.
