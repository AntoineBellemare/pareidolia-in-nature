...
ethnonym bags); the dashed line marks the full-myth level. A
species-only bag is more biome-diagnostic than the full myth, and
this survives stratification. \emph{Panel B}: matched-permutation-null ladder ---
...
$11.1\%$ chance rate (Figure~\ref{fig:fig-recovery}A). Second, a
...
(Figure~\ref{fig:fig-recovery}B). The biome signal is real and
recoverable from the model's image affinities alone, but it is a
thin overlay on a representation that is mostly about the plants
and animals the myths name and the scenes they describe.
...
vectors (bars) against a label-shuffled null (ticks); every biome
decodes above chance, at a mean of $0.66$ versus $0.50$.
...
PCA-reduced vectors, compared against the same probe trained on
