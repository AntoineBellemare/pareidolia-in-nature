...
stabilising encounters were not tied to one environment. These are
poles rather than an exhaustive dichotomy: between them sits a widely
held middle position on which ecology constrains a culture's
subsistence, attention, and vocabulary --- and so the stories
assembled from them --- without imagination being a perceptual organ
in the strong sense. The sharp test here is against the projection
pole, which alone predicts that \emph{no} biome signature survives
anonymisation; a surviving residue and its scaling with motif breadth
are what that account uniquely fails to anticipate, whereas separating
the strong coupling reading from the middle position is a matter of
interpretation we take up in the Discussion.
